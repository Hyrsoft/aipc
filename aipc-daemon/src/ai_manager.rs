use crate::ai::{AiFitMode, AiFrame, AiHub, encode_ai_frame};
...
impl Tracker {
    fn update(&mut self, current: Vec<UntrackedDetection>, pts: u64) -> Vec<AiDetection> {
...
fn map_point(frame: &AiFrame, x: f64, y: f64) -> (f64, f64) {
